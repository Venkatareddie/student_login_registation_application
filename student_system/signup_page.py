...
class SignUp:
    def __init__(self, root):
        ...
        title1 = Label(frame, text="Student Registration", font=("times new roman",25,"bold"),bg="white").place(x=20, y=10)
        title2 = Label(frame, text="Join with us", font=("times new roman",13),bg="white", fg="gray").place(x=20, y=50)

        f_name = Label(frame, text="Student First name", font=("helvetica",15,"bold"),bg="white").place(x=20, y=100)
        l_name = Label(frame, text="Student Last name", font=("helvetica",15,"bold"),bg="white").place(x=240, y=100)
        ...
        self.signup = Button(frame,text="Register",command=self.signup_func,font=("times new roman",18, "bold"),bd=0,cursor="hand2",bg="green2",fg="white").place(x=120,y=470,width=250)
