...
class login_page:
    def __init__(self, root):
       ...
       # label2 = Label(self.frame1, text= "Seek", font=("times new roman", 40, "bold"), bg="yellow", fg="RoyalBlue1").place(x=162,y=300)
        label3 = Label(self.frame1, text= "Please login your application", font=("times new roman", 18, "bold"), bg="yellow", fg="brown4").place(x=100,y=360)
        ...
        self.create_button = Button(self.frame3,text="Sign In",command=self.redirect_window,font=("times new roman",18, "bold"),bd=0,cursor="hand2",bg="green2",fg="white").place(x=80,y=320,width=250)
        ...
        if self.email_entry.get()=="" or self.password_entry.get()=="":
            ...
            try:
                ...
                if row == None:
                    ...
                    messagebox.showinfo("Success","Welcome to the SEMO family",parent=self.window)
